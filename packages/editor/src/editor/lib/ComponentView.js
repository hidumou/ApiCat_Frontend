...
export default class ComponentView {
  ...
  updateAttributes(attributes) {
    if (!this.editor || !this.editor.view || !this.editor.view.editable) {
      return
    }
  ...
  stopEvent(event) {
    ...
    const isInElement = this.dom.contains(target) && !((contentDOM = this.contentDOM) === null || contentDOM === void 0 ? void 0 : contentDOM.contains(target))
